...
export default function Footer() {
  return (
    <section className="bg-hoverButtonColor" id="footer">
      <div className="flex justify-between p-10">
        ...
        <div className="flex justify-center pt-28 w-full rounded-lg">
          <div className="flex flex-col w-[60%] gap-4">
            <p className="text-white font-semibold text-lg">Mon stage chez Vector Mind</p>
            ...
            <Link href="https://vector-mind.com/" target="_blank">
              <span className="bg-buttonColor hover:bg-white hover:text-buttonColor flex gap-3 text-white rounded-xl justify-center items-center w-[70%] sm:w-[30%] md:w-[25%] z-10 border-buttonColor border p-2 transition-all duration-300">
      ...
      <span className="text-white pl-4 mb-10 font-semibold">
